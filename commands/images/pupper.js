...
const pupper = async(msg, args, client) => {
/* eslint-enable no-unused-vars */
    ...
    if (memeThrottle[msg.author.id] > Date.now()) {
        msg.channel.send("Wait a second before using `pupper` again!");
        return;
    }
    const out = await ksoft.images.reddit("rarepuppers", { span: "week", removeNSFW: true })
...
module.exports = {
	execute: pupper,
	args: [],
	description: "Get a random post from /r/rarepuppers."
};
